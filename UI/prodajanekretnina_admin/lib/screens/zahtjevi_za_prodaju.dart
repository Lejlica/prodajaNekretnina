...
class ZahtjeviZaProdajuDetaljiScreen extends StatefulWidget {
  ...
  const ZahtjeviZaProdajuDetaljiScreen({Key? key, this.nekretnina}) : super(key: key);

  @override
  _ZahtjeviZaProdajuDetaljiScreenState createState() =>
      _ZahtjeviZaProdajuDetaljiScreenState();
}
