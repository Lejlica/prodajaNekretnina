...
import 'package:prodajanekretnina_mobile_novi/models/kupovina.dart';
...
*/
class KupovinaProvider<T> with ChangeNotifier {
  ...
  Future<Kupovina?> updateIsPaid(int id, bool isPaid) async {
    var url = "$_baseUrl$_endpoint/UpdateIsPaid/$id/$isPaid";
    var uri = Uri.parse(url);
  ...
  Future<Kupovina?> updateIsConfirmed(int id, bool isConfirmed) async {
    var url = "$_baseUrl$_endpoint/UpdateIsConfirmed/$id/$isConfirmed";
    var uri = Uri.parse(url);
    var headers = createHeaders();
  ...
  Future<Kupovina?> addPayPalPaymentId(int id, String payPalPaymentId) async {
    var url = "$_baseUrl$_endpoint/AddPayPalPaymentId/$id/$payPalPaymentId";
    var uri = Uri.parse(url);
    var headers = createHeaders();

    var response = await http!.put(uri, headers: headers);
print('Raw response from addPayPalPaymentId: ${response.body}');
    if (isValidResponseCode(response)) {
      var data = jsonDecode(response.body);
      return fromJson(data);
    } else {
