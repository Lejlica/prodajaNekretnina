...
class KomentariAgentimaProvider<T> with ChangeNotifier {
  ...
  KomentariAgentima fromJson(data) {
    // TODO: implement fromJson
    return KomentariAgentima.fromJson(data);
  }
  /* T fromJson(data) {
