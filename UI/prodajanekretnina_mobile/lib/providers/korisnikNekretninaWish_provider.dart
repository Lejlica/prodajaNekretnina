...
class KorisnikNekretninaWishProvider<T> with ChangeNotifier {
  ...
  KorisnikNekretninaWishProvider() {
    ...
    _endpoint = "KorisnikNekretninaWish";
  ...
  KorisnikNekretninaWish fromJson(data) {
    // TODO: implement fromJson
    return KorisnikNekretninaWish.fromJson(data);
  }
  /* T fromJson(data) {
