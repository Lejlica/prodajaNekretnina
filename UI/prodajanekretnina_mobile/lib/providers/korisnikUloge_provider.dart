import "package:prodajanekretnina_mobile/models/korisnikNekretninaWish.dart";
import 'package:prodajanekretnina_mobile/models/korisnikUloge.dart';
...
class KorisnikUlogeProvider<T> with ChangeNotifier {
  ...
  KorisnikUlogeProvider() {
    _baseUrl = const String.fromEnvironment("baseUrl",
        defaultValue: "https://10.0.2.2:7125/");
  ...
  KorisnikUloge fromJson(data) {
    // TODO: implement fromJson
    return KorisnikUloge.fromJson(data);
  }
  /* T fromJson(data) {
