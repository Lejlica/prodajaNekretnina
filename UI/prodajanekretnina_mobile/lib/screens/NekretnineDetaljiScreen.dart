...
import 'package:prodajanekretnina_mobile/models/nekretninaTipAkcije.dart';
import 'package:prodajanekretnina_mobile/models/tipAkcije.dart';
import 'package:prodajanekretnina_mobile/models/obilazak.dart';
import 'package:cupertino_icons/cupertino_icons.dart';
import 'package:prodajanekretnina_mobile/models/search_result.dart';
import 'package:prodajanekretnina_mobile/models/reccomendResult.dart';
...
class _NekretnineDetaljiScreenState extends State<NekretnineDetaljiScreen> {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Text(
                            "Cijena: ${_initialValue['cijena']} BAM", // Prikaz cijene iz _initialValue
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Tip nekretnine: ${_getNazivTipa(tipNekretnineId)} ", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Novogradnja: ${_initialValue['novogradnja'] == 'true' ? 'Da' : 'Ne'}",
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Broj soba: ${_initialValue['brojSoba']} ", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Broj spavaćih soba: ${_initialValue['brojSpavacihSoba']}", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Sprat: ${_initialValue['sprat']}", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Parking mjesto: ${_initialValue['parkingMjesto'] == 'true' ? 'Da' : 'Ne'}", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Namješten: ${_initialValue['namjesten'] == 'true' ? 'Da' : 'Ne'}", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: EdgeInsets.all(10),
                          child: Text(
                            "Kvadratura: ${_initialValue['kvadratura']} m2", // Prikaz cijene iz _initialValue
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                      ),
                              ...
                              FutureBuilder<List<dynamic>>(
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState ==
                                    ...
                                    return Container(
                                      height: 200,
                                      width: 800, // Take up available width
                                      padding:
                                                    ...
                                                    Expanded(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          // Add additional agent information rows here
                                                        ],
                                                      ),
                                                    ),
                                                    SizedBox(
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            if (snapshot
                                                              ...
                                                              List<dynamic>?
                                                                  data =
                                                                  snapshot.data;
                                                              // Filter the data and display agent image here
                                                              List<dynamic> filteredData = data!
                                                                  .where((nekretninaAgent) =>
                                                                      nekretninaAgent
                                                                          .nekretninaId ==
  ...
  Widget _buildDataListView() {
    print("Poziva se _buildDataListView(), ${recommendedNekretninee}");
    return Expanded(
